...
import type { CanvasProperties, FigMePage, Layer } from './types.ts';
...
export function getPageCanvasSizeInfo(
  page: Pick<FigMePage, 'id' | 'canvasColsOverride' | 'canvasRowsOverride'>,
...
export function getVisiblePageContentBounds(page: FigMePage): PageContentBounds {
  let maxCol = 0;
  let maxRow = 0;
